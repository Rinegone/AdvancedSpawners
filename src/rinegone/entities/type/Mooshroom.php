    ...
    public function getDrops(): array{
        ...
        if($this->getLastDamageCause() === EntityDamageEvent::CAUSE_FIRE){
            return [
                ...
                ItemFactory::getInstance()->get(364, 0, mt_rand(1, 2) * $lootingL),
                ItemFactory::getInstance()->get(40, 0, mt_rand(1, 2) * $lootingL),
            ];
        }else{
            return [
                ItemFactory::getInstance()->get(334, 0, mt_rand(1, 2) * $lootingL),
                ItemFactory::getInstance()->get(363, 0, mt_rand(1, 2) * $lootingL),
                ItemFactory::getInstance()->get(40, 0, mt_rand(1, 2) * $lootingL),
            ];
        }
    }
